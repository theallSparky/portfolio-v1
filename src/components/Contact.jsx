const Contact = () => {
  return (
    <div
      id="contact"
      className="max-w-[1040px] m-auto md:px-20 p-4 py-16  border border-solid mx-1 mb-1 border-red-900 md:border-2 lg:border-3 rounded-3xl hover:bg-slate-300 ease-in duration-150"
    >
