const Contact = () => {
  return (
    <div
      id="contact"
      className="max-w-[1040px] m-auto md:pl-20 p-4 py-16 mb-1 border border-solid border-red-900 md:border-2 rounded-3xl hover:bg-slate-300 ease-in duration-150"
    >
